...
<head>
    ...
    <script>
        ...
        function search() {
            ...
            var surname_Search = document.getElementById("surname_search").value;
            for (var i=1; i<arrayOfSurnmes.length; i++)
            {
                if(arrayOfSurnmes[i] == surname_Search.toString())
                {
                    alert("ID="+i);
...
<div id="wrapper">
    ...
    <table>
        <tr>
            ...
            <td>
                <div id="main_content">
                    <h1>Профілі зареєстрованих призовників</h1>
                    <table>
